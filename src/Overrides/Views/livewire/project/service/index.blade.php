{{-- =============================================================================
     OVERLAY: Modified version of Coolify's service/index.blade.php
     Changes from the original are marked with "Corelix Platform:".
     Modifications:
       1. [MULTI-PORT PROXY OVERLAY] Multi-port proxy UI for ServiceDatabase
          with coolify.proxyPorts label (General route, database resource)
       2. [TRAEFIK LABEL OVERRIDES] Per-container override of auto-generated
          Traefik labels (Advanced route for both application and database)
     ============================================================================= --}}
<div>
                ...
                @else
                    <form wire:submit='submitDatabase'>
                        ...
                        <div class="flex flex-col gap-2">
                            ...
                            {{-- [MULTI-PORT PROXY OVERLAY] Multi-port vs single-port proxy section --}}
                            <div class="flex flex-col gap-2">
                                @if ($hasMultiPortProxy)
                                    ...
                                    @endif
                                @else
                                    {{-- Original single-port proxy section --}}
                                    <div class="flex items-center gap-2 py-2">
                                        <h3>Proxy</h3>
