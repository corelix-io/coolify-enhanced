...
class Create extends Component
{
    ...
    public function mount()
    {
        ...
        if (isset($type) && isset($destination_uuid)) {
            ...
            if (in_array($type, DATABASE_TYPES)) {
                // [CORELIX ENHANCED: authorize web database creation against granular permissions]
                $this->authorize('create', $this->databasePolicyClass($type->value()));
            ...
            if ($type->startsWith('one-click-service-')) {
                // [CORELIX ENHANCED: authorize web service creation against granular permissions]
    ...
    /**
     * Map database type slug to the standalone model used by DatabasePolicy::create().
     */
    protected function databasePolicyClass(string $type): string
    {
        return match ($type) {
